...
class OpenAIEmbedder:
    ...
    def encode(self, 
        ...
        if sentences and os.path.exists(embedding_path):
            ...
            print(len(fin_embeddings)) # 211 - number of sentences
            print(len(fin_embeddings[0])) # 1536 - embed dim
        # Save embeddings
...
def main(args):
    ...
    for task in TASK_LIST[args.startid:args.endid]:
        ...
        model = OpenAIEmbedder(args.engine, task_name=task, batch_size=args.batchsize, save_emb=False)
